...
class FlxExtendedSprite extends FlxSprite
{
	...
	function updateDrag():Void
	{
		...
		{
			#if FLX_MOUSE
			x = Math.floor(FlxG.mouse.getScreenPosition(this.camera).x + scrollFactor.x * (FlxG.mouse.x - FlxG.mouse.getScreenPosition(this.camera).x))
				- _dragOffsetX;
			#end
		}
		...
		{
			#if FLX_MOUSE
			y = Math.floor(FlxG.mouse.getScreenPosition(this.camera).y + scrollFactor.y * (FlxG.mouse.y - FlxG.mouse.getScreenPosition(this.camera).y))
				- _dragOffsetY;
			#end
		}
	...
	public function startDrag():Void
	{
		...
		{
			_dragOffsetX = Math.floor(FlxG.mouse.getScreenPosition(this.camera).x
				+ scrollFactor.x * (FlxG.mouse.x - FlxG.mouse.getScreenPosition(this.camera).x)
				- x);
			_dragOffsetY = Math.floor(FlxG.mouse.getScreenPosition(this.camera).y
				+ scrollFactor.y * (FlxG.mouse.y - FlxG.mouse.getScreenPosition(this.camera).y)
				- y);
		}
		else
		{
	...
	{
		return FlxMath.pointInCoordinates(Math.floor(FlxG.mouse.getScreenPosition(this.camera).x
			+ scrollFactor.x * (FlxG.mouse.x - FlxG.mouse.getScreenPosition(this.camera).x)),
			Math.floor(FlxG.mouse.getScreenPosition(this.camera).y + scrollFactor.y * (FlxG.mouse.y - FlxG.mouse.getScreenPosition(this.camera).y)),
