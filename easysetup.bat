@echo off
title FITA Setup - Start
echo Please make sure Haxe 4.2.4 or 4.2.5 and HaxeFlixel is installed.
echo Press any key to install required libraries.
pause >nul
title FITA Setup - Installing haxelib libraries
...
title FITA Setup - User action required
cls
haxelib run flixel-tools setup
cls
...
pause >nul
title FITA Setup - Installing Git libraries
...
:InstallVSCommunity
title FITA Setup - Installing Visual Studio Community
